  ...
  if(day === "jeudi") return [
    ...
    {time:"10 min",title:"C. Skill muscle-up",tag:"Skill",kind:"accessory",
     ...
     exercises:[
       ...
       deload?"2×5 facile":peak?"4×1-2":week>=4?"5×2-3":"5×4-6",
       "poids du corps","0:45 avant C2",
       ["S1 — Base : pull-up strict, scapulas fortes. Stop avant la perte de forme.",
        "S2 — Montée : tirage haut, toucher poitrine à la barre si possible.",
        "S3 — Densité : chest-to-bar propre, chaque rep compte.",
        "S4 — Transition : low rings, simuler passage pull→dip. 2-3 reps max.",
        "S5 — Test : 1-2 muscle-ups. Qualité avant nombre.",
       ...
       "1:15 après C2","Épaules basses, amplitude complète. La force en dip est la moitié du muscle-up.")
     ]},

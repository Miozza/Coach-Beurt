// Coach Bertin V49.26 — Phase 1 : Épaules 3D + Triceps (6 semaines)
...
function shouldersBlocks(day,week){
  ...
  if(day==="lundi")return[
    {time:"7 min",title:"Warm-up push / épaules",tag:"Préparation",kind:"warmup",
     text:"Bike ou row facile 2 min + PVC pass-through 2×10 + scap push-up 2×8 + DB incline press léger 1×12 + montée strict press : barre×10, 40%×5, 55%×5."},
  ...
  if(day==="mardi")return[
    {time:"7 min",title:"Warm-up pull / scapulas",tag:"Préparation",kind:"warmup",
     text:"Row facile 3 min + open book 5/côté + scap ring row 2×8 + band face pull léger 1×20 + 1-2 séries progressives de chest row."},
  ...
  return[
    {time:"7 min",title:"Warm-up épaules",tag:"Préparation",kind:"warmup",
     text:"Row facile 2 min + PVC pass-through 2×10 + wall slides 2×10 + DB shoulder press léger 1×12 + lateral raise très léger 1×15."},

...
function shouldersBlocks(day,week){
  ...
  if(day==="lundi")return [
    ...
    {time:"0-5 min",title:"E. Optionnel si temps",tag:"Bonus",kind:"bonus",text:"Band Pull Apart 3 x 30. Fais-le seulement si les épaules se sentent mieux après, pas plus irritées."},
    {time:"5 min",title:"F. Mobilité stratégique",tag:"Mobilité",kind:"mobility",text:"Doorway Pec Stretch 2 min + Lat Stretch 2 min + Thoracic Extension 1 min."}
  ];
  if(day==="mardi")return [
    {time:"7 min",title:"Warm-up",tag:"Préparation",kind:"warmup",text:"Row 3 min + dead hang léger + scap pull-ups + band rows."},
    {time:"14 min",title:"A. Mouvement principal",tag:"Dos",kind:"main",exercises:[ex("Chest Supported Row",week===1?"4 x 10":week===2?"5 x 10":week===3?"4 x 8":"3 x 10 léger",week===3?"125 lb":"115 lb","1:45-2:00","Tirage propre, pas de swing.")]},
    {time:"12 min",title:"B. Superset arrière d'épaule",tag:"Superset",kind:"accessory",text:"Alterner B1 puis B2. Ce bloc est prioritaire pour ta posture.",exercises:[ex("B1. Rear Delt Fly",week===4?"2-3 x 15":"4 x 15-20","25 lb","0:30 avant B2","Bras longs, trapèzes calmes."),ex("B2. Face Pull",week===4?"2-3 x 15":"4 x 15-20","70 lb","0:60 après B2","Finition en rotation externe.")]},
    {time:"10 min",title:"C. Superset scapulas",tag:"Posture",kind:"accessory",text:"Contrôle lent. Pas un bloc de cardio.",exercises:[ex("C1. Trap-3 Raise",week===4?"2 x 12":"3 x 15","léger","0:30 avant C2","Pouce vers le haut, trap inférieur."),ex("C2. Ring Row Strict",week===4?"2 x 8":"3 x 10","poids du corps","0:60 après C2","Corps gainé, poitrine aux anneaux.")]},
    {time:"10 min",title:"D. WOD",tag:"Conditioning",kind:"wod",text:"EMOM 10 : min 1 = 12 cal row ; min 2 = 10 ring rows stricts. "+p.wodNote+"."},
    {time:"0-5 min",title:"E. Optionnel si temps",tag:"Bonus",kind:"bonus",text:"Farmer Carry 3 x 40 m lourd mais propre. Épaules basses, cage ouverte."},
    {time:"5 min",title:"F. Mobilité stratégique",tag:"Mobilité",kind:"mobility",text:"Open Book 2 min/côté + Scap CARs 2 min + respiration thorax ouvert 1 min."}
  ];
  if(day==="jeudi")return [
    {time:"7 min",title:"Warm-up",tag:"Préparation",kind:"warmup",text:"Bike 3 min + air squats + glute bridge + mobilité chevilles/hanches."},
    {time:"16 min",title:"A. Mouvement principal",tag:"Jambes",kind:"main",exercises:[ex("Front Squat",week===1?"5 x 5":week===2?"5 x 5":week===3?"5 x 4":"3 x 5 léger",week===1?"165 lb":week===2?"175 lb":week===3?"185 lb":"135-145 lb","2:00","Dos protégé, aucune tentative héroïque.")]},
    {time:"12 min",title:"B. Superset jambes",tag:"Superset",kind:"accessory",text:"Alterner B1 puis B2. Repos après B2.",exercises:[ex("B1. Bulgarian Split Squat",week===4?"2 x 8/jambe":"3 x 10/jambe","50 lb / main","0:30 avant B2","Amplitude propre, genou stable."),ex("B2. Standing Calf Raise",week===4?"2 x 15":"3 x 20","25 lb","0:60 après B2","Pause en haut, étirement en bas.")]},
    ...
    {time:"0-5 min",title:"E. Optionnel si temps",tag:"Bonus",kind:"bonus",text:"Reverse Sled Drag 5 min continu, léger à modéré, sans brûler les jambes."},
    {time:"5 min",title:"F. Mobilité stratégique",tag:"Mobilité",kind:"mobility",text:"Ankle Stretch 2 min + Hip Flexor Stretch 2 min + Hamstring Stretch 1 min."}
  ];
  return [
    {time:"7 min",title:"Warm-up",tag:"Préparation",kind:"warmup",text:"Row 3 min + mobilité hanches/épaules + barbell complex léger."},
    {time:"15 min",title:"A. Technique haltéro",tag:"Haltéro",kind:"main",exercises:[ex("Power Clean",week===1?"6 x 3":week===2?"7 x 3":week===3?"8 x 2":"5 x 2 léger",week===1?"155 lb":week===2?"165 lb":week===3?"175 lb":"135 lb","1:30-2:00","Vitesse et réception propre. Pas de grind.")]},
    {time:"10 min",title:"B. Giant set épaules 3D",tag:"Giant set",kind:"accessory",text:"Enchaîner les 3 mouvements, puis repos. Court et propre.",exercises:[ex("B1. Lateral Raise",week===4?"2 rounds x 15":"3 rounds x 15","20-25 lb","—","Rappel léger seulement."),ex("B2. Rear Delt Fly",week===4?"2 rounds x 15":"3 rounds x 15","25 lb","—","Arrière d’épaule."),ex("B3. Face Pull",week===4?"2 rounds x 15":"3 rounds x 15","60-70 lb","0:75 après B3","Scapulas propres.")]},
    {time:"6 min",title:"C. Triceps",tag:"Accessoire",kind:"accessory",exercises:[ex("Overhead Rope Extension",week===4?"2 x 12":"3 x 15","50-60 lb","0:60","Longue portion du triceps, aucun pincement épaule.")]},
    ...
    {time:"0-5 min",title:"E. Optionnel si temps",tag:"Bonus",kind:"bonus",text:"Farmer Carry 3 x 40 m. Stop si la prise ou les trapèzes prennent toute la place."},
    {time:"5 min",title:"F. Mobilité stratégique",tag:"Mobilité",kind:"mobility",text:"Lat Stretch 2 min + PVC Overhead Hold 2 min + Wrist Stretch 1 min."}
  ];
}
...
function renderWorkout(){
  ...
  $("focusImpact").innerHTML="<strong>"+dayIntention(state.day)+"</strong>"+(plan?"<br><strong>Progression :</strong> "+plan.label+" — "+plan.note:"");
